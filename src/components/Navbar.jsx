...
export default function Navbar() {
  ...
  return (
    <nav style={{background:'#2A1B10',padding:'0 1.5rem',position:'relative'}}>
      ...
      {menuAbierto && (
        <div style={{background:'#2A1B10',padding:'1rem 0',borderTop:'1px solid rgba(255,255,255,0.1)',maxWidth:'1100px',margin:'0 auto'}}>
          {usuario ? (
            <>
              {usuario?.rol === 'admin' ? (
